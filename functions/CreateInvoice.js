...
function createInvoiceMertz(invoice) {
  ...
  generateFooter(doc);
  const fileName = 'ed595475-63e7-4f75-8d56-7e207e83f702/'+newID+'.pdf';
...
function generateHeader(doc) {
  doc
  .image("logo-mertz.png",50, 45, { width: 120 })
  .fillColor("#444444")
  .fontSize(20)
    .text("", 110, 57)
    .fontSize(10)
    .text("Mertz kleinfruit", 200, 50, { align: "right" })
    .text("Julianaweg 6a", 200, 65, { align: "right" })
    .text("6265 AJ, Sint Geertruid", 200, 80, { align: "right" })
    .text("06-47 07 49 09", 200, 95, { align: "right" })
    .text("info@mertzkleinfruit.nl", 200, 110, { align: "right" })
    .moveDown();
}
